...
//	public static YamlConfig getOfflinePlayerYaml(String string) {
//		return new YamlConfig(RailCraft.getInstance().getDataFolder().getAbsolutePath() + File.separator + "data" + File.separator + "players" + File.separator + string + ".yml");
//	}
}
